  ...
  <div class="profile-modal-overlay" @click.self="$emit('close')">
    <div class="modal-container">
      ...
      <div class="modal-footer">
        ...
        <button @click="handleSave" class="btn-mode" :disabled="!form.name.trim()">
...
/* Recette */
.recipe-columns-header {
  display: grid;
  grid-template-columns: 1fr 110px 65px 32px;
  gap: 0.5rem;
  padding: 0 0.1rem;
}
.recipe-columns-header span {
  font-size: 0.72rem;
  font-weight: 600;
  color: #9ca3af;
  text-transform: uppercase;
...
.btn-add-ingredient:hover { background: #dcfce7; }
...
.btn-remove-ingredient:hover { color: #ef4444; }
</style>